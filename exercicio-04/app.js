...
const booleanValidation = String(typeSentence.length > characterNumber);
const anotherSentence = `A string que a "typeSentence" armazena tem mais de ${characterNumber} caracteres? ${booleanValidation[0]
  .toUpperCase()
  .concat(booleanValidation.slice(1))}.`;
